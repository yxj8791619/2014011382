package com.example.application_contentobserver;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final class ContactsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            //Toast.makeText(getApplicationContext(),"Contact data is changed.",Toast.LENGTH_LONG);

            Toast toast= Toast.makeText(getApplicationContext(),
                    "Contact data is changed", Toast.LENGTH_SHORT);
